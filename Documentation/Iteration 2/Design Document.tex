...
\begin{figure}[ht!]
    ...
    \centering
    \includegraphics[width=0.6\textwidth,height=0.6\paperheight]{Diagrams/Sequence/Admin.jpg} 
    \caption{Sequence Diagram 2: Admin Operations}
    \label{fig: Admin Operations}
    \begin{flushleft}
        If the user is authorized as an admin account, the admin page is served. This allows to view sensitive website data, update and delete clients, listings and orders as well as delete reviews.
    \end{flushleft}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 3: Cart Operations}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 4: Checkout}
    \label{fig: Checkout}
    \begin{flushleft}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 5: Edit Client Information}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 6: Filter Listings Results}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 7: Get Listing Details}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 8: Get Lists Of Listings}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 9: Get Order History}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 10: Login}
    \label{fig: Login}
    \begin{flushleft}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 11: Logout}
    \label{fig: Logout}
    \begin{flushleft}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 12: Register}
    \label{fig: Register}
    \begin{flushleft}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 13: Purchase by a Registered User}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 14: Select Listing Category}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 15: Send Confirmation Email}
...
\begin{figure}[ht!]
    ...
    \caption{Sequence Diagram 16: Sort Listings results}
