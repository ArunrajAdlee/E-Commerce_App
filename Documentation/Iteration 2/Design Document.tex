...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Add_Review.png} 
    \caption{Add Review to Listing}
    \label{fig: Add Review to Listing}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Cart_Operations.jpg} 
    \caption{Cart Operations}
    \label{fig: Cart Operations}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Categories.png} 
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Edit_Client_Info.jpg} 
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Listing_Details.png} 
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Login.jpg} 
    \caption{Login}
    \label{fig: Login}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Logout.jpg} 
    \caption{Logout}
    \label{fig: Logout}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Order_History.png} 
    \caption{Get Order History}
    \label{fig: Get Order History}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Register.jpg} 
    \caption{Register}
    \label{fig: Register}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.15\paperheight]{Diagrams/Sequence/Registered_User_Purchase.jpg} 
    \caption{Purchase by a Registered User}
    \label{fig: Purhcase by a Registered User}
\end{figure}
\begin{figure}[ht!]
    \centering
