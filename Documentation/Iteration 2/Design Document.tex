...
\begin{figure}[ht!]
    ...
    \begin{flushleft}
        Write something about add review to listing sequence diagram here!
    \end{flushleft}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \begin{flushleft}
        Write something about get order history sequence diagram here!
    \end{flushleft}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \begin{flushleft}
        Write something about select listing category sequence diagram here!
    \end{flushleft}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \begin{flushleft}
        Write something about send confirmation email sequence diagram here!
    \end{flushleft}
\end{figure}
