...
\begin{itemize}
    \item \textbf{Sell:} The system allows a registered user to add \index{product}a product and its details (price, description, image) to be able to sell the product.
    \item \textbf{Buy:} The system allows a \index{registered user}registered user to buy a product. The \index{buyer}buyer can also \index{review}review the purchased product after fifteen days.
