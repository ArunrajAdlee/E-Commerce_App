...
Our system will mainly involve the user interacting with a web application interface. The user shall create an account to be able to buy or sell \index{product}products, however user does not require to have an account for browsing the website. The user \index{information}information will be stored in a remote database server. Users will not be able to create an account or login by using any social media platforms. It will discussed in more details in future version of this documentation.
...
\index{354TheStars}354TheStars is planning to provide a worldwide platform, where various size of companies as well as individuals can sell or buy \index{product}products. All of the available products shall be eligible for sale.
...
\begin{table}[H]
        ...
        \begin{adjustbox}{width=\columnwidth,center}
            \begin{tabular}{|r | c| c | c| c|}
                ...
                \hline
                R07 & \ Admin & The \index{administrator}administrator should be able to manage user account & & US01  \\
                \hline
